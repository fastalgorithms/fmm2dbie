...
c
     ...
     1      file11(9),title(1),temp(32),file1p(10)
...
c
        equivalence (file1,file8), (file11,file4), (temp,title2),
     1      (file2,file9), (file3,file10), (file1p,file8p)
c
c       plots the points determined by x,y using itype style
c
        i1=mod(iw,10)
...
c
c
        subroutine pyplot3b(iw, x, y, n, itype, x2, y2, n2, itype2,
     1      x3, y3, n3, itype3,xmin,xmax,ymin,ymax)
        implicit real *8 (a-h,o-z)
        real *8 x(1),y(1),x2(1),y2(1),x3(1),y3(1)
        character *1 a1,a10,file1(11),file2(11),file3(11),
     1      file11(9),title(1),temp(32),file1p(10)
...
c
        ...
        write(iun87,'(a,a,a)') 'pt.plot(y1,y2,"',ls2,'")'
        write(iun87,'(a,a,a)') 'pt.plot(z1,z2,"',ls3,'")'
        write(iun87,'(a,e22.16,a,e22.16,a)') 
     1    'pt.xlim((',xmin,',',xmax,'))'
        write(iun87,'(a,e22.16,a,e22.16,a)') 
     1    'pt.ylim((',ymin,',',ymax,'))'
        write(iun87, '(a)') 'pt.axis("off")'
        write(iun87,'(a,a,a)') 'pt.savefig("',file8p,'",dpi=100)'
c        write(iun87,'(a)') 'pt.show()'
c        write(iun87,'(a)') 'pt.show()'
...
c
c
        subroutine pyplot4b(iw, x, y, n, itype, x2, y2, n2, itype2,
     1      x3, y3, n3, itype3, x4,y4,n4,itype4,xmin,xmax,ymin,ymax)
        implicit real *8 (a-h,o-z)
        real *8 x(1),y(1),x2(1),y2(1),x3(1),y3(1),x4(1),y4(1)
        character *1 a1,a10,file1(11),file2(11),file3(11),file5(11),
     1      file11(9),title(1),temp(32),file1p(10)
        character *2 ls1,ls2,ls3,ls4
        character *9 file4
        character *11 file8,file9,file10,file12
        character *10 file8p
        character *32 title2
c
        equivalence (file1,file8), (file11,file4), (temp,title2),
     1      (file2,file9), (file3,file10),(file5,file12),
     2      (file1p,file8p)
c
c       plots the points determined by x,y using itype style
c
...
c
        ls4='c.'
        if (itype4 .eq. 2) ls4='cx'
        if (itype4 .eq. 3) ls4='c-'
c
...
c
        ...
        write(iun87,'(a,a,a)') 'pt.plot(y1,y2,"',ls2,'")'
        write(iun87,'(a,a,a)') 'pt.plot(z1,z2,"',ls3,'")'
        write(iun87,'(a,a,a)') 'pt.plot(w1,w2,"',ls4,'")'
        write(iun87,'(a,e22.16,a,e22.16,a)') 
     1    'pt.xlim((',xmin,',',xmax,'))'
        write(iun87,'(a,e22.16,a,e22.16,a)') 
     1    'pt.ylim((',ymin,',',ymax,'))'
        write(iun87, '(a)') 'pt.axis("off")'
c        write(iun87,'(a,a,a)') 'pt.savefig("',file8p,'")'
        write(iun87,'(a,a,a)') 'pt.savefig("',file8p,'",dpi=100)'
c        write(iun87,'(a)') 'pt.show()'
...
c
        ...
        iun91=901
        open(unit=iun91,file=file12)
        do i=1,n4
          write(iun91,*) x4(i), y4(i)
        enddo
...
c
c
        subroutine pyimage3(iw,m,n,vals,nd,x,y,npts,x1,x2,
     1      y1,y2)
        implicit real *8 (a-h,o-z)
        integer npts(1)
        real *8 vals(m,n),target(2,m,n),x(1),y(1)
...
c         n - number of x values on the grid
c         vals - 'z' value at the x,y grid points
c         nd - number of scatterers
c         x,y - points on the scatterer
c         npts(nd) - length of x and y
c         x1,x2,y1,y2 - x and y limits for the plot
c
c       note that on exit, two files will be created - plotiw.py 
c       and plotiw.dat
c
...
c
        ...
        write(iun87,'(a,i5,a,i5,a)') 
     1      'x = x.reshape(', m, ',', n, ', order="F")'
ccc        write(iun87,'(a,a,a)') 'pt.title("', title2, '")'
        write(iun87,'(a,a,a)') 'y = np.loadtxt("',file9,'")'
        write(iun87,'(a,a,a)') 'f=open("',file10,'","r")'
        write(iun87,'(a)') 'iss = 0'
        write(iun87,'(a,i5)') 'nd = ',nd
        write(iun87,'(a)') 'for i in range(nd):'
        write(iun87,'(4x,a)') 'nn = int(f.readline())' 
        write(iun87,'(4x,a)')
     1   'pt.fill(y[iss:iss+nn,0],y[iss:iss+nn,1],facecolor="w")'
        write(iun87,'(4x,a)') 'iss=iss+nn'
        write(iun87,*)
        write(iun87,'(a,f5.2,a,f5.2,a,f5.2,a,f5.2,a)')
     1      'pt.imshow(x, extent=[',x1,',',x2,',',y1,',',y2,'])'
        write(iun87,'(a)') 'cb=pt.colorbar(shrink=.9)'
...
ccc        call prinf('ntot=*',ntot,1)
ccc        call prin2('x=*',x,ntot)
ccc        call prin2('y=*',y,ntot)
ccc        call prinf('npts=*',npts,nd)
...
c
c
        subroutine pyimage4(iw,m,n,vals,nd,x,y,npts,x1,x2,
     1      y1,y2,icmp)
        implicit real *8 (a-h,o-z)
        integer npts(1)
        real *8 vals(m,n),target(2,m,n),x(1),y(1)
...
c----------------------------------------------------
c
        subroutine pyimage6(iw,m,n,vals,x,y,npts,x1,x2,
     1      y1,y2,icmp)
        implicit real *8 (a-h,o-z)
        real *8 vals(m,n),target(2,m,n),x(1),y(1)
